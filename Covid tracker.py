...
# YOU NEED TO HAVE AN INTERNET CONNECTION FOR THIS TO WORK
# MADE BY YA BOI LJ
# BASICALLY TRACKS A SPECIFIC COMPONENT FROM THE HTML OF A WEBSITE THAT USES JAVASCRIPT
# IN WHICH REGULAR WEBSCRAPING REQUESTS LIKE BEAUTIFUL SOUP CANNOT ACCESS
